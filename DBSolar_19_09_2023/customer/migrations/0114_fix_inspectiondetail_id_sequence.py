"""
PostgreSQL: customer_inspectiondetail.id without DEFAULT nextval(...) causes NULL id
on INSERT after MySQL-style migration. Same pattern as customer.0112_fix_mseb_id_sequence.
"""
