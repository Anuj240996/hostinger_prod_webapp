"""
PostgreSQL: customer_meters.id (and related meter tables) without DEFAULT nextval(...)
causes NULL id on INSERT after MySQL-style migration. Same pattern as transactions.0010.
"""
