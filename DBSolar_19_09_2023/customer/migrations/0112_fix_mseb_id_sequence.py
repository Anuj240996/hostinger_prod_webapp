"""
PostgreSQL: customer_mseb.id without DEFAULT nextval(...) causes NULL id on INSERT
after MySQL-style migration. Same pattern as customer.0110_fix_meters_id_sequences.
"""
