"""
PostgreSQL: dashboard_staff_notification.id can lose DEFAULT nextval(...) after
legacy DB migrations, causing NULL id on INSERT.
"""
...
def forwards(apps, schema_editor):
    ...
    table = "dashboard_staff_notification"
    column = "id"
    default_seq = "dashboard_staff_notification_id_seq"
    ...
    with schema_editor.connection.cursor() as cursor:
        ...
        if not seq_name:
            ...
            cursor.execute(f"ALTER SEQUENCE {seq_name} OWNER TO {qn(owner)};")
