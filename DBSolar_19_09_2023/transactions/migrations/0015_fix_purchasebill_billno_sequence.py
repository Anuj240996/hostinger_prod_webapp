"""
PostgreSQL: PurchaseBill.billno is an AutoField but the column may have no sequence
DEFAULT (e.g. after MySQL migration). Inserts then send NULL for billno and fail.

Same approach as 0006_fix_salebill_billno_sequence.py.
"""
...
def forwards(apps, schema_editor):
    ...
    table = "transactions_purchasebill"
    column = "billno"
    default_seq = "transactions_purchasebill_billno_seq"
