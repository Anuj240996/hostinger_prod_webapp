"""
PostgreSQL: FinalSale.billno AutoField may have no sequence DEFAULT (MySQL migration).
Inserts then send NULL for billno → NOT NULL violation. Same fix as 0006 for SaleBill.
"""
...
def forwards(apps, schema_editor):
    ...
    table = "transactions_finalsale"
    column = "billno"
    default_seq = "transactions_finalsale_billno_seq"
